    ...
    try {
        const collection = db.createCollection("Project", {
            validator: {
                $jsonSchema: {
                    bsonType: 'object',
                    required: ['projectId', 'projectName', 'clientName', 'techStack', 'statusId', 'startDate'],
                    properties: {
                        projectId: {
                            bsonType: 'string',
                        ...
                        statusId: {
                            bsonType: 'number',
                            enum: [1, 2, 3, 4, 5],
                            description: 'Numeric status code representing project state (e.g., 1=open for interest, 2=pending interests, etc.)'
                        },
                        interests: {
                            bsonType: 'array',
                            uniqueItems: true,
                            ...
                            description: 'List of employee IDs who have shown interest in this project'
                        },
                        selectedInterests: {
                            bsonType: 'array',
                            uniqueItems: true,
                            ...
                            description: 'List of employee IDs whose interests have been accepted by the admin'
                        },
                        proposals: {
                            bsonType: 'array',
                            uniqueItems: true,
                        ...
                        acceptedProposal: {
                            bsonType: 'string',
                            description: 'Proposal ID that has been accepted for this project'
                        },
                        startDate: {
                            bsonType: 'date',
